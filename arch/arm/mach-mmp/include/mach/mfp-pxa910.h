...
#define VCXO_REQ		MFP_CFG_DRV(VCXOREQ, AF0, MEDIUM)
...
/* MMC1 power */
#define GPIO15_MMC1_POWER	MFP_CFG(GPIO15, AF0)

/* eMMC */
#define MMC3_DAT7_MMC3_DAT7	MFP_CFG(DF_IO7, AF1)
#define MMC3_DAT6_MMC3_DAT6	MFP_CFG(DF_IO6, AF1)
#define MMC3_DAT5_MMC3_DAT5	MFP_CFG(DF_IO5, AF1)
#define MMC3_DAT4_MMC3_DAT4	MFP_CFG(DF_IO4, AF1)
#define MMC3_DAT3_MMC3_DAT3	MFP_CFG(DF_IO3, AF1)
#define MMC3_DAT2_MMC3_DAT2	MFP_CFG(DF_IO2, AF1)
#define MMC3_DAT1_MMC3_DAT1	MFP_CFG(DF_IO1, AF1)
#define MMC3_DAT0_MMC3_DAT0	MFP_CFG(DF_IO0, AF1)
#define MMC3_CMD_MMC3_CMD	MFP_CFG(DF_CLE_SM_OEn, AF1)
#define MMC3_CLK_MMC3_CLK	MFP_CFG(SM_SCLK, AF1)
